...
export default function ReviewTab() {
  ...
  return (
    ...
    >
      <div className="flex shrink-0 flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2 py-1.5 sm:gap-4">
          {activeTab === 'prs' ? (
      ...
      <TabsContent value="prs" className="flex-1 overflow-auto pt-2">
        <PRsList
          filter={prFilter}
      ...
      <TabsContent value="issues" className="flex-1 overflow-auto pt-2">
        <IssuesList
          filter={issueFilter}
          fulcrumReposOnly={fulcrumReposOnly}
          org={selectedOrg || undefined}
