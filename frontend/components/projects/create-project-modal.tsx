...
export function CreateProjectModal({
  ...
  useEffect(() => {
    if (open) {
      setActiveTab(initialTemplateSource ? 'template' : initialTab || 'add')
      setNewRepoInput('')
      setTargetDir('')
      setFolderName('')
      setAddError(null)
  ...
  }, [open, initialTab, initialTemplateSource, defaultGitReposDir])
  ...
  return (
    <>
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab}>
                ...
                <TabsContent value="add" className="space-y-4 pt-4">
                  ...
                  <div className="flex justify-end gap-2">
                    <Button variant="outline" onClick={handleCancel} disabled={isAddPending}>
                      {t('newProject.cancel')}
                    </Button>
                    <Button
      ...
      {/* Filesystem browsers - must be outside the Dialog to avoid z-index issues */}
      <FilesystemBrowser
